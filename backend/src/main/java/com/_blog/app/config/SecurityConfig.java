        ...
        http
                ...
                .authorizeHttpRequests(auth -> {
                    auth.requestMatchers("/api/auth/**").permitAll()
                            ...
                            .requestMatchers(HttpMethod.GET, "/api/profile/postes/{profileId}").hasAnyRole("USER", "ADMIN")
                            .requestMatchers(HttpMethod.PATCH, "/api/profile").hasAnyRole("USER", "ADMIN")
                            .requestMatchers(HttpMethod.GET, "/api/profile/followers/{profileId}").hasAnyRole("USER", "ADMIN")
